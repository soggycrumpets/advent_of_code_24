...
// The only difference for part2 is the removal of the hashset of visited trail ends.
// This time, each trail end is allowed to count towards the score multiple times.
// (I didn't remove the hashset entirely, just the part where it's checked around line 126)
